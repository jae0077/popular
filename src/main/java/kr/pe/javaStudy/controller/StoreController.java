...
import kr.pe.javaStudy.dto.ResponseDTO.Create;
import kr.pe.javaStudy.dto.ResponseDTO.Update;
...
//	가게 저장
	...
	public ResponseDTO.Create saveStore(@RequestBody StoreDTO.Create dto){
		...
		try {
			...
			saveId = storeService.saveStore(new Store(user,dto.getStoreName(), dto.getTel(), dto.getAddress(), dto.getOpenTime(), dto.getCloseTime(), dto.getStoreImage()));
			result = true;
